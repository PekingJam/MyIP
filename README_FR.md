...
![Website](https://img.shields.io/website?url=https%3A%2F%2Fipcheck.ing&up_message=online&label=IPinfo)
...
| `IPChecking_API_KEY` | Non | `""` | Clé API pour IPinfo, utilisée pour obtenir des informations de géolocalisation précises sur l'adresse IP |
